...
<body>
    <header>
        ...
        <div class="boxCategory2 box">
            <h2>Categorias</h2>
            <?php
            include '../php/category/tableCategory.php';
            ?>
            <div class="boxPrint buttonCategory">
                <a href="../php/category/printCategory.php"><button class="buttonCategory">Imprimir categorias</button></a>
            </div>
        </div>
    </header>
</body>
